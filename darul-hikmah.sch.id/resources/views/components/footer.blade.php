<footer class="footer-area">
    <div class="footer-top bg-img default-overlay pt-130 pb-80"
         style="background-image:url({{asset($background ?: 'assets/images/bg-4.jpg')}});">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="footer-widget negative-mrg-30 mb-40">
                        ...
                        <div class="footer-list">
                            <ul>
                                <li><a href="https://ra.darul-hikmah.sch.id">Raudhatul Athfal</a></li>
                            ...
                            <ul>
                                ...
                                @php
                                    $gallery->images->map(function ($item) {
                                        print ('<li><a href="#"><img src="'.$item.'" alt=""></a></li>');
                                    })
                                @endphp
                                @endif
                            </ul>
