...
import {show as showArticle, update as updateArticle} from "../../utils/api/article.jsx"
...
const ArticleCreate = () => {
    ...
    const OnUpdate = (e) => {
        ...
        updateArticle(params).then (() => setLoading(false)).catch(() => setLoading(false))
    }
        ...
        <React.Fragment>
            ...
            <Content>
                <BlockHead size="lg">
                    ...
                    <BlockBetween>
                        <BlockHeadContent>
                            <BlockTitle className="page-title">Ubah Artikel</BlockTitle>
                            <BlockDes>
                                <p>Perbarui Artikel yang telah disimpan.</p>
                            </BlockDes>
                        </BlockHeadContent>
                        <BlockHeadContent>
                            <Button
